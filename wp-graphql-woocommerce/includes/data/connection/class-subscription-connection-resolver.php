<?php
/**
 * ConnectionResolver - Subscription_Connection_Resolver
 *
...
/**
 * Class Subscription_Connection_Resolver
 *
 * @deprecated v0.10.0
 */
class Subscription_Connection_Resolver extends AbstractConnectionResolver {
	/**
	...
	public function get_query_args() {
		 ...
		 */
		$query_args = apply_filters( 'graphql_subscription_connection_query_args', $query_args, $this->source, $this->args, $this->context, $this->info );
