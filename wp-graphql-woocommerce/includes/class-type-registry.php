...
class Type_Registry {
	...
	public function init( \WPGraphQL\Registry\TypeRegistry $type_registry ) {
		...
		\WPGraphQL\WooCommerce\Type\WPEnum\Subscription_Status::register();
		...
		//\WPGraphQL\WooCommerce\Type\WPObject\Subscription_Item_Type::register();
		\WPGraphQL\WooCommerce\Type\WPObject\Order_Type::register();
		\WPGraphQL\WooCommerce\Type\WPObject\Subscription_Type::register();
		...
		\WPGraphQL\WooCommerce\Connection\Subscriptions::register_connections();
