<?php
/**
 * WPObject Type - Subscription_Type
 *
...
//use WPGraphQL\WooCommerce\Data\Connection\Subscription_Item_Connection_Resolver;
		...
		register_graphql_object_type(
			...
			array(
				...
				'fields'      => array(
                    ...
                    'startDate'                  => array(
                        'type'        => 'String',
                        'description' => __( 'Start Date', 'wp-graphql-woocommerce' ),
                    ),
                    'lastOrderDate'                  => array(
                        'type'        => 'String',
                        'description' => __( 'Last order date', 'wp-graphql-woocommerce' ),
                    ),
                    'nextPaymentDate'                  => array(
                        'type'        => 'String',
                        'description' => __( 'Date next payment', 'wp-graphql-woocommerce' ),
                    ),
					'modified'              => array(
						'type'        => 'String',
