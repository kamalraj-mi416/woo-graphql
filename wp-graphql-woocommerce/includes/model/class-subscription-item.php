 ...
 *
 * Resolves model for WC Subscription item crud objects
 *
...
class Subscription_Item extends Model {
	...
	public function __construct( $item ) {
		...
		$restricted_cap = apply_filters( 'subscription_item_restricted_cap', '' );
	...
	/**
	 * Initializes the WC Subscription field resolvers
	 */
