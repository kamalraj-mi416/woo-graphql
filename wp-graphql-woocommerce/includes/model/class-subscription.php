 ...
 * Model - Subscription
 *
 * Resolves WC subscription crud object model
 *
 ...
 * Class Subscription
 */
class Subscription extends WC_Post {
	...
	protected function owner_matches_current_user() {
		// Get Customer ID.
		if ( 'shop_subscription' === $this->post_type ) {
	...
	protected function init() {
		if ( empty( $this->fields ) ) {
			...
			$fields = array(
				...
				'startDate'       => function() {
					return ! is_null( $this->wc_data->get_date('start', 'site') ) ? $this->wc_data->get_date('start','site') : null;
				},
				'lastOrderDate'       => function() {
					return ! is_null( $this->wc_data->get_date( 'last_order_date_created', 'site' ) ) ? $this->wc_data->get_date( 'last_order_date_created', 'site' ) : null;
				},
				'nextPaymentDate'       => function() {
					return ! is_null( $this->wc_data->get_date( 'next_payment', 'site' ) ) ? $this->wc_data->get_date( 'next_payment', 'site' ) : null;
				},
				/**
