<?php
/**
 * ConnectionResolver - Subscription_Item_Connection_Resolver
 *
 * Resolves connections to Subscriptions
 *
...
/**
 * Class Subscription_Item_Connection_Resolver
 */
class Subscription_Item_Connection_Resolver extends AbstractConnectionResolver {
	...
	public function get_query_args() {
		 ...
		 */
		$query_args = apply_filters( 'graphql_subscription_item_connection_query_args', $query_args, $this->source, $this->args, $this->context, $this->info );
	...
	public function get_query() {
		...
		foreach ( $items as $item ) {
			$this->loader->prime(
				$item->get_id(),
				new \WPGraphQL\WooCommerce\Model\Subscription_Item( $item )
			);
		}
