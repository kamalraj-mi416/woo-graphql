	...
	public static function register_fields() {
		register_graphql_fields(
			...
			array(
                ...
                'subscription'            => array(
                    'type'        => 'Subscription',
                    'description' => __( 'A subscription object', 'wp-graphql-woocommerce' ),
                    'args'        => array(
                        'id'     => array(
                            'type'        => 'ID',
                            'description' => __( 'The ID for identifying the subscription', 'wp-graphql-woocommerce' ),
                        ),
                        'idType' => array(
                            'type'        => 'SubscriptionIdTypeEnum',
                            'description' => __( 'Type of ID being used identify subscription', 'wp-graphql-woocommerce' ),
                        ),
                    ),
                    'resolve'     => function ( $source, array $args, AppContext $context ) {
                        $id      = isset( $args['id'] ) ? $args['id'] : null;
                        ...
                        if ( empty( $order_id ) ) {
                            /* translators: %1$s: ID type, %2$s: ID value */
                            throw new UserError( sprintf( __( 'No subscription ID was found corresponding to the %1$s: %2$s', 'wp-graphql-woocommerce' ), $id_type, $id ) );
                        } elseif ( get_post( $order_id )->post_type !== 'shop_subscription' ) {
                            /* translators: %1$s: ID type, %2$s: ID value */
                            throw new UserError( sprintf( __( 'No subscription exists with the %1$s: %2$s', 'wp-graphql-woocommerce' ), $id_type, $id ) );
                        }
                        ...
                        $subscription = $is_authorized ? Factory::resolve_crud_object( $order_id, $context ) : null;
                        return $subscription;
                    },
                ),
