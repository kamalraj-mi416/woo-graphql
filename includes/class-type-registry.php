...
class Type_Registry {
	...
	public function init( \WPGraphQL\Registry\TypeRegistry $type_registry ) {
		...
		Type\WPEnum\Subscription_Status::register(); // Custom woo-graphql code
		...
		// Type\WPObject\Subscription_Item_Type::register(); // Custom woo-graphql code
		Type\WPObject\Order_Type::register();
		Type\WPObject\Subscription_Type::register(); // Custom woo-graphql code
		...
		Connection\Subscriptions::register_connections(); // Custom woo-graphql code
